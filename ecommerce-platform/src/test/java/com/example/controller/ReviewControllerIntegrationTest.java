...
@WebMvcTest(value = ReviewController.class, excludeAutoConfiguration = org.springframework.boot.autoconfigure.security.servlet.SecurityAutoConfiguration.class)
...
class ReviewControllerIntegrationTest {
    ...
    void createReview_success() throws Exception {
        ...
        // Create a ReviewRequestDTO for the request body
        ReviewRequestDTO reviewRequest = new ReviewRequestDTO(1L, 1L, 5, "Great product!");
